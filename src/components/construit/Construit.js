...
function Construit() {
  return (
    <section className="px-[20%] py-[100px]">
      <div className="grid grid-rows-2 lg:grid-cols-2 lg:gap-8">
        <div>
          <img className="h-auto w-[500px]" src={contruit} alt="construit" />
        </div>
        <div>
          <h1 className="text-5xl text-center lg:text-left leading-[62px]">Construit pour et par les créatifs</h1>
          <p className="py-[30px] leading-8 text-center lg:text-left text-xl" >
          ...
          <div className="grid grid-rows-2  lg:grid-cols-3 gap-7 py-[30px]">
